                    ...
                    <Tabs defaultValue="overview" className="space-y-4">
                        ...
                        <TabsContent value="overview" className="space-y-4">
                            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                                ...
                                <Card>
                                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                        <CardTitle className="text-base font-medium">Reputation Points</CardTitle>
                                        <Rocket />
                                    </CardHeader>
                                    <CardContent>
                                ...
                                <Card>
                                    ...
                                    <CardContent>
                                        <div className="text-3xl font-bold">40 <span className="text-xs">ETH</span></div>
                                    </CardContent>
                                </Card>
                                <Card>
                                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                                    ...
                                    <CardContent>
                                        <div className="text-3xl font-bold">25 <span className="text-xs">ETH</span></div>
                                    </CardContent>
                                </Card>
                            </div>
